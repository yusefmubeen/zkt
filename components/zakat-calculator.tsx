        ...
        <CardContent className="pt-0">
          <div className="space-y-3">
            ...
            >
              <label
                htmlFor="silver"
                className="flex items-start space-x-3 bg-gray-800 rounded-lg p-3 border border-gray-500 hover:border-green-500 focus-within:border-green-500 focus-within:ring-2 focus-within:ring-green-500/50 transition-colors cursor-pointer w-full flex-1"
              >
